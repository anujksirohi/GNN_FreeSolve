...
#plt.bar(groups, rmse)
plt.bar(groups, rmse, color=colors)
# plt.bar(groups, mea)
# plt.bar(groups, r_2)
# plt.bar(groups, pearson)

plt.xlabel(r'Groups', fontsize=24, fontweight='bold')
plt.ylabel(r'RMSE (kcal/mol)', fontsize=24, fontweight='bold')
...
plt.savefig('rmse.eps', dpi=300, bbox_inches='tight', format='eps')
plt.tight_layout()
#plt.show()